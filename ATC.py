...
def Photos():
    global Door,img,fsm
    Door=ImageTk.PhotoImage((Image.open("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Door_closed.jpg")).resize((710,400)))
    img=ImageTk.PhotoImage((Image.open("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Switch_off.jpg")).resize((710,400)))
    fsm=ImageTk.PhotoImage((Image.open("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/nfa.jpeg")).resize((480,270)))
def Button_pack():
    frame = Frame(root)
    frame1 = Frame(root)
    frame2 = Frame(root)
...
def Set_Temp():
    ...
    if Choice == "50°C, Top, 15 Min":
        player = tkvideo("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Temperature_50.mp4", my_label, loop = 0, size = (250,400))
        player.play()
        ...
        player = tkvideo("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Temperature_100.mp4", my_label, loop = 0, size = (250,400))
        player.play()
        action = Label(root,text = "Setting Temperature, Mode and Timer...",font = ("",10,"italic"))
        t1 = Timer(0.315, action.pack)
        t1.start()
        ...
        player = tkvideo("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Temperature_200.mp4", my_label, loop = 0, size = (250,400))
        player.play()
        action = Label(root,text = "Setting Temperature, Mode and Timer...",font = ("",10,"italic"))
        t1 = Timer(0.315, action.pack)
        t1.start()
...
def Open_Door():
    ...
    my_label = Label(root)
    my_label.pack()
    player = tkvideo("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Door_Open.mp4", my_label, loop = 0, size = (710,400))
    player.play()
...
def Close_Door():
    ...
    my_label = Label(root)
    my_label.pack()
    player = tkvideo("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Door_Close.mp4", my_label, loop = 0, size = (710,400))
    player.play()
...
def Switch_On():
    ...
    my_label = Label(root)
    my_label.pack()
    player = tkvideo("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Switch_on.mp4", my_label, loop = 0, size = (710,400))
    player.play()
...
def Switch_Off():
    ...
    t1 = Timer(0.315, action.pack)
    t1.start()
    player = tkvideo("C:/Users/ginge/Documents/PROGRAMMING/Python/ATC/Switch_off.mp4", my_label, loop = 0, size = (710,400))
    player.play()  
    t = Timer(0.95, lambda:[action.destroy(),Button_pack()])  
    t.start()
root = Tk()
